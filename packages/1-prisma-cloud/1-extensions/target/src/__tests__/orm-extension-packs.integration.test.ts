...
import { applyOrmMigration, targetStorageHash } from '../orm-migrate.ts';
...
describe.skipIf(pgServer === undefined)('applyOrmMigration with a declared extension pack', () => {
