/** The `raw-postgres` node kind's descriptor: one Prisma Postgres Database (plus its Connection), warmed before any consumer deploys. */
 ...
 * exactly once.
 */
export function rawPostgresDescriptor(o: () => ResolvedCloudOptions): NodeDescriptor {
