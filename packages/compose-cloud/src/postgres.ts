import type { Contract, DependencyEnd, ResourceNode } from '@prisma/compose';
import { dependency, resource, string } from '@prisma/compose';
...
export function postgres(opts?: {
  ...
  if (opts?.name !== undefined) {
    return resource({
      name: opts.name,
      extension: '@prisma/compose-cloud',
