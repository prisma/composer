 ...
 *
 * Kept apart from `./control` on purpose. `./control` is the programmatic
 * deploy pipeline; this is the command surface: grammar, help and arg
 * validation belong to the engine, and the handlers behind them are the same
 * operations `./control` exposes.
 *
