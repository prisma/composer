# Prisma Compose Design Docs

This directory is the **source of truth** for Prisma Compose’s architecture and design. It is intended to be consumed by:
...
- Other teams integrating with Prisma Compose (platform/orchestration/tools)
...
1. `docs/design/00-purpose/README.md` (what Prisma Compose is and why it matters)
